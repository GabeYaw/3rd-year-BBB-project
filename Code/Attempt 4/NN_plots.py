...
plt.figure()
plt.plot(range(1, len(adc_progress) + 1), adc_progress, marker='o', linestyle='-')
plt.xlabel('Epoch')
...
plt.figure()
plt.plot(range(1, len(sigma_progress) + 1), sigma_progress, marker='o', linestyle='-')
plt.xlabel('Epoch')
...
plt.figure()
plt.plot(range(1, len(axr_progress) + 1), axr_progress, marker='o', linestyle='-')
plt.xlabel('Epoch')
...
plt.figure()
plt.plot(range(1, len(axr_unclamped_progress) + 1), axr_unclamped_progress, marker='o', linestyle='-')
plt.xlabel('Epoch')
